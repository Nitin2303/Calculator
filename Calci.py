...
from tkinter import *
console = tk.Tk()
console.geometry("170x250")
console.title("python-calculator")
console.maxsize(170,250)
console.minsize(170,250)
ent = tk.Entry(console, width=16, borderwidth=3, relief=tk.RIDGE)
...
def clearf():
    ent.delete(0, "end")
clean = Button(console,text="C",width=2,command=clearf,bg="green",fg="white",relief=RIDGE)
...
Char_seven = Button(console,text="7",width=2,command=lambda : ent.insert("end","7"),borderwidth=3,relief=RIDGE)
Char_seven.grid(row=1,sticky="w",padx=75)
Char_plus = Button(console,text="+",width=2,command=lambda : ent.insert("end","+"),borderwidth=3,relief=RIDGE)
...
Char_four = Button(console,text="4",width=2,command=lambda : ent.insert("end","4"),borderwidth=3,relief=RIDGE)
Char_four.grid(row=2,sticky="w",padx=75,pady=5)
Char_minus = Button(console,text="-",width=2,command=lambda : ent.insert("end","-"),borderwidth=3,relief=RIDGE)
...
Char_one = Button(console,text="1",width=2,command=lambda : ent.insert("end","1"),borderwidth=3,relief=RIDGE)
Char_one.grid(row=3,sticky="w",padx=75,pady=5)
Char_multiply = Button(console,text="*",width=2,command=lambda : ent.insert("end","*"),borderwidth=3,relief=RIDGE)
...
Char_dot = Button(console,text=".",width=2,command=lambda : ent.insert("end","."),borderwidth=3,relief=RIDGE)
Char_dot.grid(row=4,sticky="w",padx=75,pady=5)
Char_divide = Button(console,text="/",width=2,command=lambda : ent.insert("end","/"),borderwidth=3,relief=RIDGE)
Char_divide.grid(row=4,sticky="e",padx=125,pady=5)
result = Button(console,text="=",width=10,command=fresult,bg="green",fg="white",borderwidth=3,relief=RIDGE)
result.grid(row=5,sticky="w",padx=15,pady=5)
Char_modulus = Button(console,text="%",width=2,command=lambda : ent.insert("end","%"),borderwidth=3,relief=RIDGE)
Char_modulus.grid(row=5,sticky="e",padx=125,pady=5)
delete = Button(console,text="del",width=2,command=delete,borderwidth=3,relief=RIDGE)
delete.grid(row=5,sticky="w",padx=80,pady=5)
la = Label(console,text="Developed by Nithiin")
la.place(relx=0.0,rely=1.0,anchor="sw")
